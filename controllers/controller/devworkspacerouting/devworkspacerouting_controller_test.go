	...
	Context("Basic DevWorkspaceRouting Tests", func() {
		...
		Context("Kubernetes - DevWorkspaceRouting Objects creation", func() {
			...
			It("Creates ingress", func() {
				...
				Expect(createdIngress.ObjectMeta.Annotations).Should(HaveKeyWithValue(constants.DevWorkspaceComponentNameAnnotation, testMachineName), "Ingress should have component name annotation")
				...
				Expect(discoverableEndpointIngress.ObjectMeta.Annotations).Should(HaveKeyWithValue(constants.DevWorkspaceComponentNameAnnotation, testMachineName), "Ingress should have component name annotation")
		...
		Context("OpenShift - DevWorkspaceRouting Objects creation", func() {
			...
			It("Creates route", func() {
				...
				Expect(createdRoute.ObjectMeta.Annotations).Should(HaveKeyWithValue(constants.DevWorkspaceComponentNameAnnotation, testMachineName), "Route should have component name annotation")
				...
				Expect(discoverableRoute.ObjectMeta.Annotations).Should(HaveKeyWithValue(constants.DevWorkspaceComponentNameAnnotation, testMachineName), "Route should have component name annotation")
